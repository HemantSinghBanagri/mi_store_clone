...
const Footer = ({footer}) => {
  return (
    ...
    <div>{repeatIcon}
      ...
      <br/>10-day replacement policy on mi.com
      </p>
      </div>

      <div>{shieldIcon} <p><b>100% secure payments</b><br></br>
      we support Cards, Walltes, EMI and COD
      </p></div>

      <div>{mapIcon}<p><b>Vast Service network </b><br></br>
      1000 Mi service-center across 600 cities 
      </p>
      </div>
    ...
    <div className="PreFooter2">
        ...
        <div>Chat with our Virtual AI bot (24/7 Live agent Support)
